...
function App() {
  return (
    <div>
      ...
      <BrowserRouter>
        <div>
          <h1>Student user stories with React</h1>
          <ul className="header">
            <li><NavLink to="/mapa">Map of Mexico City</NavLink></li>
            <li><NavLink to="/mapaTienda">Stores</NavLink></li>
            <li><NavLink to="/favoritos">My Favorite Stores</NavLink></li>
          </ul>
          <div className="content">
            <Routes>
              <Route path='mapa'  element={<Mapa />} />
              <Route path="favoritos" element={<Favoritos />} />
              <Route path="mapaTienda" element={<MapaTiendas />} />
            </Routes>
          </div>
        </div>
      </BrowserRouter>
